...
var BsDaterangepickerInputDirective = (function () {
    function BsDaterangepickerInputDirective(_picker, _config, _localeService, _renderer, _elRef, changeDetection) {
        var _this = this;
    ...
    BsDaterangepickerInputDirective.prototype.writeValue = function (value) {
        ...
        if (!value) {
            ...
            this._value = _input
                .map(function (_val) {
                return parseDate(_val, _this._config.dateInputFormat, _this._localeService.currentLocale);
            })
